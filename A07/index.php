...
if (isset($_POST['btnSubmitUser'])) {
  ...
  $userQuery = "INSERT INTO userinfo (firstName, lastName, birthDate) VALUES ('$firstName', '$lastName', '$birthDate')";
...
<body>
  ...
  <div class="container mb-5 d-flex justify-content-center" style="background-color: #ABBA7C; width: 400px; padding: 30px; border-radius: 10px;">
    <form method="post" class="w-100">
      ...
      <button type="submit" name="btnSubmitUser" class="btn btn-primary">Add User</button>
    </form>
  </div>
